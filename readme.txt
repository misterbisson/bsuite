...
*NOTE: this release does not yet include working stats tools.* Previous bSuite/bStat users should see installation notes for details.

== Installation ==

1. Upload `bsuite` to the `/wp-content/plugins/` directory
1. Activate bSuite through the 'Plugins' menu in WordPress
1. Activate any desired optional plugins through the 'Plugins' menu in WordPress

*Previous bSuite/bStat users* should not disable their old plugin yet. bSuite3 does not conflict with previous versions, a forthcoming release will include updated and optimized stats tracking.
