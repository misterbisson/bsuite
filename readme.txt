...
The upgrader will not remove any old tables, but you should feel free do remove them on your own using a MySQL management tool. The new tables all include `bsuite3` in their name. A step by step screenshot walkthrough of the upgrader is available here: 

http://www.flickr.com/photos/maisonbisson/1887867841/
...
3. <a href="http://spiralbound.net/">Cliff Pearson</a>'s Quickstats, part of bStat.
...
6. <a href="http://spiralbound.net/">Cliff Pearson</a>'s use of the bSuite Recently Commented widget, part of bSuite. This widget differs from the built in Recent Comments widget in that it only shows posts, not individual comments.
